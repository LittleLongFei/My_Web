...
st.markdown("张辉，男，汉族，1999年12月生，山东沂水人，中共党员，中国自动化学会会员，IEEE student member。本科毕业于山东建筑大学，连续四年学习成绩位列专业第一，获得综合性奖励60余项，")
st.markdown("曾担任三个实验室以及信息与电气工程学院创新基地学生负责人，后获得国家“推荐优秀本科毕业生免试攻读硕士研究生”资格，保送至山东大学控制科学与工程学院攻读硕士学位。由于硕士阶段表现优异，")
st.markdown("科研能力突出，经个人申请、专家推荐、导师同意获得“硕博连读”资格，于硕士二年级直接攻读博士学位。")
...
st.success("Patent")
st.markdown("已授权")
st.caption("[1] **张辉**, 聂浩, 齐美荣, 侯振华, 一种基于物联网的安防设备, ***实用新型专利***")
st.caption("[2] **张辉**, 聂浩, 齐美荣, 侯振华, 一种基于物联网的快递收发系统, ***实用新型专利***")
st.markdown("已公开")
st.caption("[3] 陶亮, 王锐霖,  **张辉**, 孙佳杰, 张良, 一种手持式智能残留农药检测仪以及检测方法, ***国家发明专利***")
st.markdown("受理中")
st.caption("[4] 孙波, **张辉**, 张立志, 一种含氢综合能源系统的全流程一体化设计方法及系统, ***国家发明专利***")
st.markdown("已投稿")
st.caption("[5] 孙波, **张辉**, 一种氢气泄漏扩散过程建模方法及系统, ***国家发明专利***")
st.caption("[6] 孙波, 李志龙, **张辉**, 一种基于自适应PINN的综合能源数字孪生建模方法及系统, ***国家发明专利***")
st.caption("[7] 孙波, 张良, **张辉**,一种基于物理信息神经网络的供热管网建模方法及系统, ***国家发明专利***")

st.success("Software")
st.markdown("已授权")
st.caption("[1] **张辉**, 彭伟, 侯振华, 计算机软件著作权《基于ID3算法的大学生恋爱软件V1.0》 ***计算机软件著作权***")
st.caption("[2] **张辉**, 计算机软件著作权, 《基于C4.5算法的寻亲软件V1.0》, ***计算机软件著作权***")
...
st.markdown("已结题")
st.caption("[1] **国家电网科技项目**, 多能互补综合能源系统协同优化控制研究, **参与, 项目骨干**, 经费**300万**元")
st.markdown("在研")
st.caption("[2] **国家重点研发计划项目**, 管道氢气在城镇供能领域关键技术研究与规模应用, **参与, 项目骨干**, 经费**5.15亿**元")
st.caption("[3] **国家重点研发计划项目**, 氢能多场景深度融合及智慧管控技术研究与示范应用, **参与, 项目骨干**, 经费**2.05亿**元")
st.markdown("本科阶段")
st.caption("[4] **国家级大学生创新创业训练计划项目**, 基于区间二型模糊逻辑的建筑能耗预测平台, **参与, 指导**, 经费**2万**元")
st.caption("[5] **省级大学生创新创业训练计划项目**, 基于实景投影的农药残留检测技术, **主持**, 经费**1万**元")
st.caption("[6] **开放性实验项目**, 基于STM32的智能晾衣架控制系统, **主持**, 经费**1千**元")
st.caption("[7] **开放性实验项目**, 基于Arduino的创新机器人开发平台, **主持**, 经费**1千**元")
st.caption("[8] **开放性实验项目**, 简易无接触温度测量与身份识别防疫装置, **主持**, 经费**1千**元")
...
st.caption("[1] 2022 **山东大学新生入学奖学金**（奖学金：¥3000）")
st.caption("[2] 2020-2021学年 **国家奖学金**（BZK202137426，奖学金：¥8000）")
st.caption("[3] 2019-2020学年 **国家励志奖学金**（奖学金：¥5000）")
st.caption("[4] 2021-2022学年 **第二届泉城奖学金**（奖学金：¥5000）[全校第二]")
st.caption("[5] 2020-2021学年 **山发集团创新创业奖学金**（奖学金：¥2000）")
st.caption("[6] 2021-2022学年 **山发集团创新创业奖学金**（奖学金：¥2000）")
st.caption("[7] 2020年度 **山东建筑大学十大自强不息优秀学生**, （荣誉、称号、奖学金：¥5000）[全校第十]")
st.caption("[8] 2019年度 **山东建筑大学校级建业之星学习先进个人**, （荣誉、称号、奖学金：¥1200）")
st.caption("[9] 2018-2019学年 **优秀学生二等奖学金**（奖学金：¥800）")
st.caption("[10] 2019-2020学年 **优秀学生二等奖学金**（奖学金：¥800）")
st.caption("[11] 2020-2021学年 **优秀学生一等奖学金**（奖学金：¥1200）")

st.caption("[12] 山东建筑大学2022届优秀毕业生")
st.caption("[13] 2022届优秀学士学位论文《基于深度模糊系统方法的多变量时间序列预测方法研究及应用》，毕业论文以及答辩成绩全学院第一 ")
st.caption("[14] 山东建筑大学2019寒假社会实践活动优秀个人")
st.caption("[15] 山东建筑大学2020暑期社会实践活动优秀个人")
st.caption("[16] 2018-2019年度山东建筑大学“优秀团员”")
st.caption("[17] 2019-2020年度山东建筑大学“优秀团员”")
st.caption("[18] 2020-2021年度山东建筑大学“优秀团员”")
st.caption("[19] 2018-2019年度山东建筑大学“优秀学生”")
st.caption("[20] 2019-2020年度山东建筑大学“优秀学生”")
st.caption("[21] 2020-2021年度山东建筑大学“优秀学生”")
st.caption("[22] 2019-2020年度山东建筑大学“优秀学生干部”")
st.caption("[23] 2020-2021年度山东建筑大学“优秀学生干部”")
st.caption("[24] 2019-2020年度山东建筑大学“优秀学生干部标兵”")
st.caption("[25] 2020-2021年度山东建筑大学“优秀学生干部标兵”")
st.caption("[26] 2020-2021年度山东建筑大学“优秀学生标兵”")

st.markdown("竞赛获奖")

st.caption("[1] 第十四届iCAN国际创新创业大赛国家级三等奖, 项目负责人，iCAN20201227J69")
st.caption("[2] 2020年TI杯全国大学生电子设计竞赛山东赛区一等奖, 项目负责人")
st.caption("[3] 第十二届大学生科技节-科技馆展品创意与设计大赛省级一等奖《基于Arduino的激光雕刻机》, 第二作者, SDUC202051-1-0044")
st.caption("[4] 第十二届大学生科技节-科技馆展品创意与设计大赛省级一等奖《基于Arduino的智能避障车》, 第一作者, SDUC202051-1-0049")
st.caption("[5] “科创青春，未来我行”科普展品征集活动省级一等奖, 第二作者，SU10001468")
st.caption("[6] “科创青春，未来我行”科普展品征集活动省级二等奖, 第一作者，SU10001466")
st.caption("[7] 第十四届iCAN国际创新创业大赛山东赛区省级二等奖, 项目负责人, iCAN2020-SD-18542")
st.caption("[8] 第十一届大学生科技节-科技馆展品创意与设计大赛省级三等奖, 第二作者, SDUC201961-3-0032")
st.caption("[9] 第七届山东省物联网创造力大赛省级二等奖, 项目负责人, SDUC202007-2-0113")
st.caption("[10] 第一届中国·山东数字经济优秀项目省级三等奖, 项目负责人")
st.caption("[11] 第一届中国·山东数字经济优秀项目春苗奖以及奖金, 项目负责人, 奖金：¥5000")
st.caption("[12] 第十四届大学生科技节-科技馆展品创意与设计大赛省级优秀奖《基于STM32的函数信号发生器》")
st.caption("[13] 第十四届大学生科技节-科技馆展品创意与设计大赛省级优秀奖《基于STM32的示波器硬件设计与实现》")
st.caption("[14] “华为杯”山东建筑大学第六届单片机大赛校赛一等奖、华为杯三等奖, 第二作者")
st.caption("[15] 建行杯第六届山东省“互联网+”山东建筑大学校赛二等奖, 项目负责人")
st.caption("[16] 山东建筑大学2020年“创青春”创业大赛校级铜奖, 项目负责人")
st.caption("[17] 第七届山东省大学生科技创新大赛—山东建筑大学校赛三等奖, 项目负责人")
st.caption("[18] 山东建筑大学第十二届“挑战杯”创业计划赛校级铜奖, 项目负责人")
st.caption("[19] 建行杯第六届山东省“互联网+”山东建筑大学校赛二等奖, 项目负责人")
st.caption("[20] 山东建筑大学“喜迎七十华诞与祖国同在同行”征文比赛 校级三等奖")
st.caption("[21] 信息与电气工程学院第三届职业生涯规划演讲比赛 院级三等奖")
st.caption("[22] 信息与电气工程学院“铭记一二九，共筑中国梦”征文比赛 院级二等奖")
st.caption("[23] 信息与电气工程学院党史答题活动 院级一等奖")
st.caption("[24] 计算机科学与技术学院“滑翔机竞速大赛” 院级一等奖")
st.caption("[25] 2019年零“艾”活动优秀志愿者")

st.markdown("资质证书")

st.caption("[1] 英语等级证书, 四级, 192137007006711")
st.caption("[2] 全国计算机等级证书, 二级, C语言程序设计, 2453701390442")
