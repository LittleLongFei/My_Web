...
st.markdown("张辉，男，汉族，1999年12月生，山东沂水人，中共党员，中国自动化学会会员，IEEE student member。本科毕业于山东建筑大学，连续四年学习成绩位列专业第一，累积获得综合性奖励60余项，")
st.markdown("曾担任三个实验室以及信息与电气工程学院创新基地学生负责人，后获得国家“推荐优秀本科毕业生免试攻读硕士研究生”资格，保送至山东大学控制科学与工程学院攻读硕士学位。由于硕士阶段表现优")
st.markdown("异，科研能力突出，经个人申请、专家推荐、导师同意获得硕博连读资格，于硕士二年级直接攻读博士学位。")
...
st.markdown("待投稿")
st.caption("[5] **H.Zhang**, KV.Gao, W.Peng*. Mini-Batch Forward Automatic Differentiation based on Efficient Adaptive Optimization Algorithm for TSK Fuzzy Systems, ***IEEE TRANSACTIONS ON FUZYY SYSTEMS***, SCI-Q1, ***TOP***, IF=11.9")
...
st.caption("[10] **H.Zhang**, LZ.Zhang, B.Jia, B.Sun*. ***IEEE TRANSACTIONS ON SMART GRID***, SCI-Q1, ***TOP***, IF=9.6")
st.caption("[11] **H.Zhang**, B.Sun*, XF.Li. ***NATURE METHODS***, SCI-Q1, ***TOP***, IF=48")


st.success("Patent")
st.markdown("受理中")
st.caption("[1] 孙波, **张辉**, 张立志, 一种含氢综合能源系统的全流程一体化设计方法及系统, ***国家发明专利***")
st.markdown("已投稿")
st.caption("[2] 孙波, **张辉**, 一种氢气泄漏扩散过程建模方法及系统, ***国家发明专利***")
